...
public abstract class BaseShapeFragment extends Fragment {
    ...
    //    String... - prostsze uzycie, wszystkie parametry, ktore beda na koncu pakowane sa do tablicy
    //    konstruktor oczewkujacy na wszystkie parametry
...
//                    wynik w metodzie, ktora dopiero powstanie, bo nie wiadomo JAK policzyc pole
//                    abstrakcyjnej figury
    ...
    private void generateFields(View rootView, LinearLayout linearLayout) {
        for (int i = 0; i < editTexts.length; i++) {
            ...
            //            1sza czesc kodu to domyslna sciezka wywolania
